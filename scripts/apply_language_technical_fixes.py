...
def ensure_social_preview_metadata() -> None:
    image_url = "https://damian545-dj.github.io/raport-publiczny/assets/social-preview-report-correspondence-scales.jpg"
    alt_by_language = {
...
def add_metadata_and_structured_data() -> None:
    ...
    for path in ROOT.rglob("*.html"):
        ...
        text = re.sub(
            ...
            "assets/social-preview-report-correspondence-scales.jpg",
            text,
        )
